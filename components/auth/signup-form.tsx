        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
          ...
          <div className="flex items-start gap-3 text-sm p-4 bg-gray-50 border border-blue-900">
            ...
            <span className="text-gray-600 leading-relaxed">
              با ثبت‌نام، شما{" "}
              <a href="/terms" className="text-blue-900 hover:text-blue-800 font-medium underline transition-colors">
                قوانین و مقررات
              </a>{" "}
              و{" "}
              <a href="/privacy" className="text-blue-900 hover:text-blue-800 font-medium underline transition-colors">
                حریم خصوصی
              </a>{" "}
              را می‌پذیرید
            </span>
