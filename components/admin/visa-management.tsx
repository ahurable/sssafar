// components/admin/visa-management.tsx
"use client"
...
import { Plus, Edit, Trash2, MapPin, Clock, DollarSign, Users, Calendar } from "lucide-react"
...
export function VisaManagement() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("آیا از حذف این خدمت ویزا اطمینان دارید؟")) return
  ...
  if (loading) {
    return <div className="text-center py-8">در حال بارگذاری خدمات ویزا...</div>
  }

  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <p className="text-muted-foreground">{services.length} خدمت ویزا</p>
        <Button onClick={() => router.push('/admin/visa/new')}>
